...
namespace FlightJobs.Schedule
{
    public class WarningEmailJob : IJob
    {
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            await SendEmailWarningForAirlineDebtAsync();
        }
        ...
        public async Task SendEmailWarningForLicenseAsync()
        {
            ...
            try
            {
                ...
                foreach (var item in listOverdue)
                {
                    ...
                    sb.Append($"<p><a href='http://flight-jobs.net' target='_blank'><img src='http://flight-jobs.net/Content/img/FlightJobsLogo0001.png' /></a></p><hr />");
                    ...
                    sb.Append($"<p>FlightJobs is free. If you like it, please consider to make a donation.</p>");
                    sb.Append($"<p>http://flight-jobs.net</p>");
        ...
        public async Task SendEmailWarningForAirlineDebtAsync()
        {
            var dbContext = new ApplicationDbContext();
            try
            {
